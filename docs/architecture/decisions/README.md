...
Architecture Decision Records capture material decisions that are expensive to reverse, affect
multiple modules, or constrain security, reliability, and operations.
